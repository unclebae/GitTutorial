...
![create git repository](./imgs/creategit01.png "create git repository")

이렇게 리포지토리를 생성합니다.

### 리포지토리 이름 지정하기

![create_git_repository](./imgs/creategit02.png "enter a name")
...
![view repsoitory info](./imgs/creategit03.png "view a repository")
